...
public class RunToPose extends Action {
    ...
    PositionController xController = new PositionController(0.15, 0);
    PositionController yController = new PositionController(0.15, 0);
    ...
    double startVel = 0, maxVel = 15, maxAccel = 10;
